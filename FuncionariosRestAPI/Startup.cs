...
namespace FuncionariosRestAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DataContext>(options => options.UseInMemoryDatabase("FuncionariosDB"));
            services.AddScoped<IAccessLayer, AccessLayer>();
